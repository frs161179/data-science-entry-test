...
answer_Q8b = """
Reason 1: prompt b is concise, breaking down task and covers everything necessary without wasting words
Reason 2: prompt b breakdown task looks similar to Agile methodology, promotes user story that will speed up AI analysis process
"""

# Q8c: What is ONE strength of the prompt you did NOT choose?
# Your answer:
answer_Q8c = """
ONE strength : customer feedback through an online survey.
"""
...
rewrite prompt:
1. Identify age groups and products with the lowest satisfaction scores.
2. "Exclude/ignore lowest satisfaction scores that do not have written comments (blank comments)"
3. Extract the most common themes from the written comments.
4. Summarise findings in an executive summary paragraph.
Audience: CEO presentation on Friday.
Constraints: Keep the summary concise and free of technical jargon.

explanation for steps no 2:
- Possibility of human input via online survey -> example customer intends to input rating 5 but wrongly input to low rating.
- Low possibility of low rating to have a blank comment (unwritten comment) 
  * Unsatisfied customer most likely writes negative feedback (instead of putting blank comment).
- Exclude blank comment will help AI to speed up process on finding common themes from the written comments
"""
